...
final class V060ReleaseReadinessTests: XCTestCase {
    ...
    func testV060ReleaseHygieneAndWorkspaceGuardDocumentsExist() throws {
        ...
        XCTAssertTrue(hygiene.localizedStandardContains("Closed without merge"))
        XCTAssertTrue(hygiene.localizedStandardContains("no code accepted"))
        XCTAssertTrue(hygiene.localizedStandardContains("Do not resurrect, cherry-pick"))
        XCTAssertTrue(hygiene.localizedStandardContains("Any future console redesign must start from current main"))
    ...
    func testV060PublicationAuditRecordsReleasedCompleteState() throws {
        ...
        XCTAssertTrue(document.localizedStandardContains("PR #454"))
        XCTAssertTrue(document.localizedStandardContains("excluded from v0.6.0"))
        XCTAssertTrue(document.localizedStandardContains("closed without merge"))
        XCTAssertTrue(document.localizedStandardContains("no code accepted"))
        XCTAssertTrue(document.localizedStandardContains("Issue #449"))
        XCTAssertTrue(document.localizedStandardContains("backlog"))
        XCTAssertTrue(document.localizedStandardContains("tracked separately as an enhancement backlog item"))
        XCTAssertTrue(document.localizedStandardContains("Next action | No release action required"))
        XCTAssertFalse(document.localizedStandardContains("PR #454 | open Draft"))
        XCTAssertFalse(document.localizedStandardContains("reopen PR #454"))
