enum SwitcherPersistenceKeys {
    ...
    static let companyDisplayName = "branding.companyName"
    static let cornerLogo = "cornerLogo_path"
    static let cornerLogoVisible = "cornerLogo.isVisible"
    ...
    static let agendaReminderEnabled = "agendaReminderEnabled"
    static let legacyAutoAdvanceAtScheduledTime = "autoAdvanceAtScheduledTime"
